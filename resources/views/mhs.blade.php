                                    ...
                                    <tr class="border-b dark:border-gray-700">
                                        ...
                                        <td class="flex items-center">
                                            <ul class="text-sm">
                                                <li>
                                                    <button
                                                        onclick="openUpdateModal('{{ $mahasiswa->user_id }}', '{{ $mahasiswa->nim }}', '{{ $mahasiswa->nama }}', '{{ $mahasiswa->tempat_lahir }}', '{{ $mahasiswa->tanggal_lahir }}', '{{ $mahasiswa->kelas_id }}')"
                    ...
                    <form id="updateMhsForm" action="" method="POST">
                        ...
                        <div class="grid gap-4 mb-4 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="number" name="kelas_id" id="update_kelas_id"
                                    class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    disabled>
                            </div>
                            <div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.openUpdateModal = function(user_id, nim, nama, tempat_lahir, tanggal_lahir, id, kelas_id) {
                ...
                // document.getElementById('updateMhsForm').action = '/mhs/' + id;
                // document.getElementById('update_kelas_id').value =
                // kelas_id; // Atur nilai kelas_id jika diperlukan
                // //document.getElementById('update_edit').value = false; // Menyertakan input hidden dengan nilai default
